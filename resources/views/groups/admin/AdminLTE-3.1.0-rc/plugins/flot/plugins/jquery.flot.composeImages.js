...
function, which generates temporary project out of them. This function
...
failure in generating the temporary image. Temporary project are required
...
After all temporary project are generated, they are overlapped using
...
temporary project load their data.
*/
    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                successCallbackFunc(tempImg); //call successCallback, to allow snapshot of all working project
            };
    ...
    function prepareImagesToBeComposed(sources, destination) {
        ...
        if (sources.length === 0) {
            ...
            if ((maxX - minX <= 0) || (maxY - minY <= 0)) {
                result = NEGATIVEIMAGESIZE; //this might occur on hidden project
            } else {
